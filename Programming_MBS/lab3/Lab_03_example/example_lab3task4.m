...
% -------------------------------------------------------------------------
pos(:,1) = [1; 1; 0]; % position of frame 1 in frame 0
...
rot(:,1) = [0;0;0]; % frame 1 in world frame
rot(:,2) = [0;pi/2;0]; % frame 2 in frame 1
rot(:,3) = [0;0;0]; % frame 3 in frame 2
%rot(:,4) = [0;0;0]; % frame 4 in frame 3
% ...

e.pos = [1;0;0]; % position in last frame
...
if 0
    for i = 1:3
        ...
        plot_chain(pos,rot,e,q+[0;0;0.2*i]);
    end
end
