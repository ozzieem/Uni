...
class Cluster(object):
    ...
    def calculateCentroid(self):
        ...
        centroid_coords = [int(sum(dList)/numPoints) for dList in unzipped]
...
def kmeans(points, k, cutoff):
    ...
    print("Initial centroids: " + str(initial))
...
def makeRandomPoint(n, lower, upper):
    ...
    '''
    p = Point([int(random.uniform(lower, upper)) for _ in range(n)])
    return p
