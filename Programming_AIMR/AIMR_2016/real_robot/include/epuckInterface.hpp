...
protected:
  ...
  enum Request
  {
    ...
    SELECT_COMMAND = 0X19,  ///< RFID select command
    READ_COMMAND   = 0X20,  ///< RFID select command
    WRITE_COMMAND  = 0X21,  ///< RFID select command
    RESET_STEPS = 0X24,  ///< RFID select command
    SET_STEPS   = 0X25,  ///< RFID select command
    SET_TARGET_STEPS= 0X26  ///< RFID select command
  };
