...
//int rrr=read(this->fileDescriptor+1, array, length);
...
void
SerialPort::sendCharArray(unsigned char* const array, int size) const
{
  int tmp = 0;
  tmp = write(this->fileDescriptor, array, size);
